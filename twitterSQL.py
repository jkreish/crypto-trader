...
"""
Created on Wed Dec 20 13:10:03 2017
...
t = Twython(app_key='xIMbCH63I7wZVKLsbCfDRJQbA',
            app_secret = 'XYlzVBw51g6zaMtGTFn0Bel6lUR7dYO2WTD5zDZaMeNtuNOuAA',
            oauth_token = '303849647-1L75gCMjlIMgJETtH7BaZMEf6btrNJsrG4s1x313',
            oauth_token_secret = 'aeeCD0zxAhe5hZVYwIKMn8yGv4BhwWX1MPwwiu9F0K2GC')

ids = ['%23BTC', '%23bitcoin', '%23bitcoinprice', ]
...
def get_data(kid, max_id=None):
    try:
        ...
        print ("Error reading id %s, exception:", kid)
    print ("d.keys(): ", d.keys()) 
...
def write_data(self, d):   
    ...
    for entry in d['statuses']:
        ...
        entities_mentions.join(u", ")
        entities_hashtags.join(u", ")
        entities_urls.join(u", ")
        entities_expanded_urls.join(u", ")
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///twittercryptohashtag.sqlite", echo=False)  
